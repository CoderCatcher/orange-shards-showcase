...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Portfolio" },
      { name: "description", content: "All my 5+ years of experience in one place" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Portfolio" },
      { property: "og:description", content: "All my 5+ years of experience in one place" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Portfolio" },
      { name: "twitter:description", content: "All my 5+ years of experience in one place" },
